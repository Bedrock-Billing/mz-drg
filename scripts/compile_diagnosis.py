...
def compile_diagnosis():
    ...
    cursor.execute("SELECT key, version_start, version_end, value FROM diagnosisAll ORDER BY key, version_start")
    diagnoses = []
    ...
    with open(BIN_PATH, "wb") as f:
        ...
        # Write Header
        f.write(struct.pack("<IIIII", magic, num_schemes, num_diagnoses, schemes_offset, diagnoses_offset))
